...
//     if (abResult == 1) // left
//     {
//         storyText("You follow path to the left, tomorrow you should arrive at [Vontel's Rest]");
//         // enterLocation(206);
//     }
//     else // right
//     {
//         storyText("You follow path to the right, tomorrow you should arrive at [The Oasis]");
